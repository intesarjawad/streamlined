...
export default function PlaylistCard({ playlist, onEdit, onDelete }: PlaylistCardProps) {
  ...
  useEffect(() => {
    ...
    const updateTime = () => {
      setTimeAgo(formatDistanceToNow(new Date(playlist.updatedAt), { addSuffix: true }));
    };
  ...
  }, [mounted, playlist.updatedAt]);

  // Initial render shows static time
  const initialTimeDisplay = mounted ? timeAgo : 'recently';
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="flex items-center justify-between text-sm text-white/50">
            ...
            <span className="inline-flex items-center gap-1 shrink-0">
              ...
              Last updated {initialTimeDisplay}
            </span>
          </div>
